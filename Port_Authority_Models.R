...
# Basic residual diagnostic plots (4-in-1)
par(mfrow = c(3,3))  # 2x2 layout
plot(model)

# Reset plot layout
par(mfrow = c(1, 1))

# Optional: Fancy residual vs fitted plot
...
# Optional: QQ plot for normality
ggqqplot(residuals(model), title = "Normal Q-Q Plot of Residuals")
